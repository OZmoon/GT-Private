...
string shop_list = "", opc_list = "", shop_list2 = "", shop_list2_2 = "", zombie_list = "", surgery_list = "", voucher_list = "", exe_text =  "", small_text = "", rare_text = "", rainbow_text = "";
vector<pair<int, int>> lockeitem, untradeitem, opc_item, zombieitem, surgeryitem, voucheritem;
...
int items_dat() {
	...
	for (int i = 0; i < itemCount; i++) {
		...
		if (def.id == 448 || def.id == 5816 || def.id == 6856 || def.id == 6858 || def.id == 6860 || def.id == 8186 || def.id == 8188 || def.id == 9266) def.untradeable = 1;
		...
		if (i == 4984)items[i].max_gems3 = 50000;
		...
		if (i == 10884) items[i].noob_item = { { 8558, 10 }, { 4296, 1 }, { 1258, 10 }, { 1260, 10 }, { 1262, 10 }, { 1264, 10 }, { 1266, 10 }, { 1268, 10 }, { 1270, 10 }, { 4318, 10 }, { 4312, 10 }, { 4308, 10 }, { 4314, 10 }, { 4310, 10 }, { 4316, 10} };
		if (i == 10916) items[i].noob_item = { {6520, 5}, {6538, 5}, {6522, 5}, {6528, 5}, {6540, 5}, {6518, 5}, {6530, 5}, {6524, 5}, {6536, 5}, {6534, 5}, {6532, 5}, {6526, 5} };
		if (i == 11652) items[i].noob_item = { {11598, 50}, {11600, 20}, {11602, 20}, {11604, 50}, {11606, 20}, {11608, 50}, {11610, 100}, {11612, 50}, {11614, 100}, {11616, 50}, {11618, 20} };
		...
		if (i == 1680) {//sfw
			...
			items[i].rare_item = { { 2854,1},{ 3696,1},{ 4820,1},{ 6312,1},{ 8588,1},{ 9730,1},{ 11008,1 } };
		...
		if (i == 7346) {
			items[i].noob_item = { { 7362,5},{ 7364,5},{9126,5},{10254,5},{9128,5},{11374,1},{7352,1},{7354,1},{7356,1},{7358,1},{7360,1},{10256,1},{10282,1},{11376,1},{12854,1},{7348,1},{7342,1},{9130,5},{11370,5},{9132,1},{5286,1},{5288,1},{5290,1},{5292,1},{5296, 1},{5298,1},{7366,1},{11372,1} };
			items[i].rare_item = { { 12904,1}, {11354,1},{9134,1},{10294,1} };
			items[i].newdropchance = 50;
		}
		if (i == 9286) {
			items[i].noob_item = { { 5768,1},{5766,1},{13084,1},{13078,1}, {5744,1},{11628,1},{10664,1},{10596,1},{7698,1},{9282,1},{9280,1},{11656,1},{10592,1},{10590,1},{9290,1},{5758,1},{5756,1},{5760,1},{5762,1},{10598,1},{9284,1},{10582,1},{11632,1},{11634,1} };
			items[i].rare_item = { { 5754,1},{7696,1},{9272,1},{10576,1},{10578,1},{11622,1} };
			items[i].newdropchance = 50;
		}
		if (i == 5750) {
			items[i].noob_item = { { 202,1},{204,1},{206,1},{5766,1},{5768,1},{13090,3},{5744,1},{7688,1},{7690,1},{7694,1},{7686,1},{7692,1 } };
			items[i].rare_item = { { 9286,1},{9286,1},{9286,1},{4994,1},{ 2978,1},{13086,1},{13066,1}, { 5766,1},{ 5768,1},{5756,1},{5758,1},{5760,1},{5762,1},{5754,1},{7698,1},{7696,1},{9286,1},{9272,1},{9286,1},{9286,1},{9286,1 } };
			items[i].newdropchance = 1500;
		}
		if (i == 13054) {
			items[i].noob_item = { {13096,5},{13090,5},{13090,3},{13088,3},{13100,3},{13098,1},{13086,1},{13094,1},{13072,1},{13082,1},{13050,1} };
			items[i].rare_item = { {13062,1},{13060,1},{11626,1},{13058,1},{13070,1} };
			items[i].newdropchance = 50;
		}
		if (i == 2306) {
			items[i].noob_item = { { 10560,1},{13036,1}, {13046,1}, {13044,1},{13028,1},{13048,1}, {10558,1},{10546,1},{1408,1},{1410,1},{1412,1},{1414,1},{1416,1},{1418,1},{2280,1},{2290,1},{2288,1},{3274,1},{4372,1},{4378,1},{4370,1},{4366,1},{5504,1},{5508,1},{5512,1},{5490,1},{5514,1},{5496,1},{9242,1},{9244,1},{9246,1},{9248,1},{9258,1},{9260,1},{11584,1 } };
			items[i].rare_item = { { 7672,1},{10526,1 }, {12994,1}, };
			items[i].newdropchance = 40;
		}
		if (i == 7672) {
			items[i].noob_item = { { 7668,2},{7666,5},{7662,3},{11574,3},{13000,1}, {13002,1}, {11572,1},{7664,3},{10568,1},{1406,1 } };
			items[i].rare_item = { { 9256,1},{ 11544,1},{ 10492,1}, {12996,1}, {13030,1}, { 9262,1},{ 7660,1},{ 10494,1},{ 11534,1},{ 10534,1 } };
		...
		if (i == 11476) { // Black Friday Black Box Xtreme
			...
			items[i].rare_item = { {10332,1},{ 12856,1},{ 12858,1},{ 12860,1},{ 12862,1},{ 12864,1 }, };
		...
		if (i == 5404) {
			...
			items[i].rare_item = { {5424,1} ,  {12882,1}, { 12888,1 }, {5422,1}, {5456,1}, {7398,1}, {7414,1}, {7396,1}, {9194,1}, {9172,1} };
			items[i].newdropchance = 25;
		}
		if (i == 5402) {
			items[i].noob_item = { { 5394,1 }, { 9180,1 }, { 5474,1 }, { 5384,1 }, { 7458,1 }, { 1778,1 }, { 12938,1 }, { 12922,1 }, { 5348,1 }, { 5350,1 }, { 12926,1 }, { 12928,1 }, { 12930,1 }, { 12932,1 }, { 13016,1 }, { 5352,1 }, { 5354,1 }, { 5476,1 }, { 228,1 }, { 5472,1 }, { 7454,1 }, { 9196,1 }, { 5364,1 }, { 5386,1 }, { 5358,1 }, { 5360,1 }, { 5362,1 }, { 7436,1 }, { 5400,1 }, { 5478,1 }, { 5370,1 }, { 5368,1 }, { 5396,1 }, { 5470,1 }, { 7438,1 }, { 3204,1 }, { 5372,1 }, { 7446,1 }, { 7448,1 } };
			items[i].rare_item = { {5404,1} };
			items[i].newdropchance = 120;
		}
		if (i == 11758) {//G4G Spcial Hamper
			items[i].noob_item = { {11756,3},{10778,1},{10782,1},{10774,1},{10784,1},{10780,1},{10776,1},{10786,1},{10758,1},{10754,1},{10394,1} };
			items[i].rare_item = { {10748,1}, {11884, 1}, {11768,1}, {11760,1}, {8944,1}, {1970,1}, {11118,1}, {1460,1}, {9036,1}, {9758,1}, {10026,1}, {8284,1}, {10388,1}, {11318,1}, {10252,1}, {5754,1}, {9446,1}, {1458,1}, {4664,1}
			};
			items[i].newdropchance = 2500;
		}
		if (i == 11756) {
			items[i].noob_item = { {1486,1},{9526,1}, {10842,1},{10834,1}, {10840,1}, {10394, 1}, {10784,1},{10838,1},{10836,1},{10782,1}, {10786,1}, {10776,1}, {11782,2}, {11778,2},{11780,2} };
			items[i].rare_item = { {10778,1},{11758,1}, {10780, 1} };
			items[i].newdropchance = 1000;
		}
		if (i == 12830) {
			items[i].noob_item = { {9018,1},{9026,1}, {26, 1}, {780, 1}, {1220, 1}, {856, 1}, {1212, 1}, {11346, 1 }, {12794, 1 }, {1210, 1 }, {3122, 1} };
			items[i].rare_item = { {1234,1},{6842,1}, {10188, 1}, {12832, 1} };
			items[i].newdropchance = 2000;
		}
		if (i == 12832) { //Halloween special 
			items[i].noob_item = { {4184,1},{6842,1}, {7150, 1}, {26, 1}, {10188, 1}, {780, 1}, {4326, 1}, {4328, 1}, {7122, 1}, {12830, 2}, {1220, 1}, {856, 1}, {1212, 1}, {4182, 1}, {12794, 1}, {1210, 1}, {3122, 1} };
			items[i].rare_item = { {11140,1},{4330,1}, {1970, 1}, {11748, 1} };
			items[i].newdropchance = 20500;
		}
		if (i == 12044) {
			items[i].noob_item = { {12318,1},{12320,1}, {12322,1},{12324,1}, {12324,1}, {12326, 1}, {12328,1},{12330,1},{12028,1},{12030,1}, {12042,1}, {12044,1}, {12046,1}, {12048,1},{12050,1},{12052,1} };
			items[i].rare_item = { {12024,1},{12026,1} };
			items[i].newdropchance = 1000;
		}
		if (i == 12046) {
			items[i].noob_item = { {12318,1},{12320,1}, {12322,1},{12324,1}, {12324,1}, {12326, 1}, {12328,1},{12330,1},{12028,1},{12030,1}, {12024,1},{12026,1}, {12042,1}, {12044,1}, {12046,1}, {12048,1},{12050,1},{12052,1},{12054,1},{12056,1},{12058,1},{12060,1},{12062,1},{12064,1},{12066,1},{12068,1},{12070,1},{12072,1},{12074,1},{12076,1},{12078,1},{12080,1},{12082,1},{12084,1},{12086,1},{12088,1},{12090,1},{12092,1},{12094,1},{12096,1},{12098,1},{12100,1},{12102,1},{12104,1},{12106,1},{12108,1},{12110,1},{12112,1},{12114,1},{12116,1},{12118,1},{12120,1},{12122,1},{12124,1},{12126,1},{12128,1},{12130,1},{12132,1},{12134,1},{12136,1},{12138,1},{12140,1},{12142,1},{12144,1},{12146,1},{12148,1},{12150,1},{12152,1},{12154,1},{12156,1} };
			items[i].rare_item = { {12014,1},{12016,1},{12018,1},{12020,1} };
			items[i].newdropchance = 1000;
		}
		if (i == 12262) {
			items[i].noob_item = { {12208,1},{12210,1}, {12212,1},{12214,1}, {12216,1}, {12218, 1}, {12220,1},{12222,1} };
			items[i].rare_item = { {12264,1} };
			items[i].newdropchance = 1000;
		}
		if (i == 12264) {
			items[i].noob_item = { {12208,1},{12210,1}, {12212,1},{12214,1}, {12216,1}, {12218, 1}, {12220,1},{12222,1}, {12182,1},{12174,1} };
			items[i].rare_item = { {12184,1} };
			items[i].newdropchance = 1000;
		}
		if (i == 6858) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1} };
			items[i].rare_item = { {10858, 2},{10858, 2} };
			items[i].newdropchance = 2000;
		}
		if (i == 6856) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1} };
		...
		if (i == 6860) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1}, {10858, 1}, {10858, 1} };
			items[i].rare_item = { {10858, 2},{10858, 3} };
			items[i].newdropchance = 2000;
		}
		if (i == 6862) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1}, {10858, 1}, {10858, 2}, {10858, 2} };
			items[i].rare_item = { {10858, 3},{10858, 5}, {10858, 10}, {1796, 50} };
			items[i].newdropchance = 2000;
		}
		if (i == 8186) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1}, {10858, 1}, {10858, 2}, {10858, 2} };
			items[i].rare_item = { {10858, 5},{10858, 10}, {1796, 30} };
			items[i].newdropchance = 2500;
		}
		if (i == 8188) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1}, {1796, 10}, {10858, 1}, {10858, 1}, {10858, 5}, {10858, 5} };
			items[i].rare_item = { {10858, 10},{10858, 20}, {1796, 50}, {7188, 1} };
			items[i].newdropchance = 2500;
		}
		if (i == 9266) {
			items[i].noob_item = { {10858,1},{10858,1}, {10858, 1}, {10858, 1}, {10858, 2}, {10858, 1}, {10858, 1} };
			items[i].rare_item = { {1796, 5},{10858, 5}, {1486, 10}, {1796, 10} };
			items[i].newdropchance = 2000;
		}
		if (i == 10538) {
			items[i].noob_item = { { 5394,1 }, { 9180,1 }, { 12934,1 }, { 12936,1 }, { 13018,1 }, { 5474,1 }, { 5384,1 }, { 7458,1 }, { 1778,1 }, { 12938,1 }, { 12922,1 }, { 5348,1 }, { 5350,1 }, { 12926,1 }, { 12928,1 }, { 12930,1 }, { 12932,1 }, { 13016,1 }, { 5352,1 }, { 5354,1 }, { 5476,1 }, { 228,1 }, { 5472,1 }, { 7454,1 }, { 9196,1 }, { 5364,1 }, { 5386,1 }, { 5358,1 }, { 5360,1 }, { 5362,1 }, { 7436,1 }, { 5400,1 }, { 5478,1 }, { 5370,1 }, { 5368,1 }, { 5396,1 }, { 5470,1 }, { 7438,1 }, { 3204,1 }, { 5372,1 }, { 7446,1 }, { 7448,1 } };
			items[i].rare_item = { {10536,1} };
			items[i].newdropchance = 25;
		}
		if (i == 10536) {//Special Winter Wish
			items[i].noob_item = { {7414,1}, {5404, 1}, {11454, 1}, {12884,1 }, {13014,1 }, {9194, 1}, {5426, 1}, {11480, 1}, {7398, 1}, {10404, 1}, {5422, 1}, {7406, 1}, {5424, 1} };
			items[i].rare_item = { {11466,1},{10498,1}, {10412, 1}, {12958,1 }, {10410, 1}, {10424, 1}, {11478, 1} };
		...
		if (i == 11398) {//Alien Landing POD
			items[i].noob_item = { {10990, 1}, {12972, 1}, {12974, 1}, {12976, 1}, {12978, 1}, {12980, 1}, {11000, 1}, {11410, 1}, {11426, 1}, {10996, 1}, {11408, 1}, {11448, 1}, {11450, 1}, {11452, 1}, {11412, 1}, {11414, 2}, {10998, 1}, {11422, 5}, {10994, 1} };
		...
		if (i == 8286) items[i].zombieprice = 2000;
		if (i == 7734) items[i].zombieprice = 180;
		if (i == 1674) items[i].zombieprice = 150;
		if (i == 1970) items[i].zombieprice = 125;
		if (i == 2592 || i == 1780 || i == 1782) items[i].zombieprice = 100;
		if (i == 6312 || i == 9758) items[i].zombieprice = 60;
		if (i == 11012) items[i].zombieprice = 48;
		if (i == 7188 || i == 6312 || i == 8284) items[i].zombieprice = 35;
		if (i == 11748 || i == 11050) items[i].zombieprice = 22;
		if (i == 12644 || i == 11308 || i == 12434 || i == 11442 || i == 11884 || i == 11308 || i == 12836 || i == 11706 || i == 12248 || i == 11908 || i == 12874 || i == 13024) items[i].zombieprice = 12;
		if (i == 4330 || i == 4762 || i == 6802)  items[i].zombieprice = 10;
		if (i == 11476 || i == 11758) items[i].zombieprice = 5;
		if (i == 11156 || i == 1486 || i == 9350 || i == 1796) items[i].zombieprice = 3;
		if (i == 3604 || i == 3798 || i == 2480 || i == 2410) items[i].zombieprice = 1;
		...
		if (i == 11156 || i == 1486 || i == 9350 || i == 1796) items[i].voucherprice = 3;
		if (i == 3604 || i == 3798 || i == 2480 || i == 2410) items[i].voucherprice = 1;
		if (items[i].voucherprice != 0) voucheritem.push_back(make_pair(items[i].voucherprice, i));
		...
		//locke shop
		if (i == 8202 || i == 2478 || i == 2724)  items[i].gtwl = 2;
		if (i == 10394)  items[i].gtwl = 3;
		if (i == 3738)  items[i].gtwl = 5;
		if (i == 1210 || i == 1008 || i == 2978 || i == 2572)  items[i].gtwl = 10;
		if (i == 3818 || i == 1978 || i == 6286)  items[i].gtwl = 15;
		if (i == 3560)  items[i].gtwl = 20;
		if (i == 3798 || i == 6288)  items[i].gtwl = 25;
		if (i == 2476 || i == 2480 || i == 3104 || i == 6290)  items[i].gtwl = 50;
		if (i == 2754)  items[i].gtwl = 70;
		if (i == 3894)  items[i].gtwl = 75;
		if (i == 8892)  items[i].gtwl = 80;
		if (i == 4516 || i == 8194 || i == 2452 || i == 1486)  items[i].gtwl = 100;
		if (i == 11156)  items[i].gtwl = 150;
		if (i == 10396)  items[i].gtwl = 150;
		if (i == 8820 || i == 8818 || i == 5738 || i == 9408)  items[i].gtwl = 400;
		if (i == 3114 || i == 8024 || i == 8026 || i == 7166 || i == 6144 || i == 5078 || i == 5084 || i == 5080 || i == 5082 || i == 4972 || i == 4970 || i == 5264)  items[i].gtwl = 500;
		if (i == 2284 || i == 3616 || i == 11476)  items[i].gtwl = 700;
		if (i == 4948 || i == 5260 || i == 11134)  items[i].gtwl = 1000;
		if (i == 1804)  items[i].gtwl = 1100;
		if (i == 3300 || i == 2282) items[i].gtwl = 1500;
		if (i == 8816)  items[i].gtwl = 3000;
		if (i == 6312)  items[i].gtwl = 5000;
		if (i == 2450) items[i].gtwl = 9500;
		if (i == 4802)  items[i].gtwl = 12000;
		if (items[i].gtwl != 0) lockeitem.push_back(make_pair(items[i].gtwl, i));



		// untradealbe shop 12256
		if (i == 11462)  items[i].u_gtwl = 725;
		if (i == 9326)  items[i].u_gtwl = 150;
		if (i == 6866 || i == 6896 || i == 6898 || i == 6900 || i == 6902 || i == 6904 || i == 7020 || i == 12640) items[i].u_gtwl = 500;
		if (i == 10684 || i == 12958) items[i].u_gtwl = 2000;
		if (i == 6872 || i == 10694 || i == 8620 || i == 10714 || i == 10890 || i == 11536 || i == 12992) items[i].u_gtwl = 2500;
		if (i == 7670) items[i].u_gtwl = 1000;
		if (i == 6874 || i == 8032 || i == 12958) items[i].u_gtwl = 5000;
		if (i == 6878 || i == 8306 || i == 9410) items[i].u_gtwl = 10000;
		if (i == 9006) items[i].u_gtwl = 12500;
		if (i == 7586) items[i].u_gtwl = 15000;
		if (i == 1782 || i == 1780 || i == 2592)  items[i].u_gtwl = 65000;
		if (i == 11118)  items[i].u_gtwl = 100000;
		if (i == 11462)  items[i].u_gtwl = 725;
		if (i == 9326)  items[i].u_gtwl = 15000;
		if (i == 6026 || i == 11140 || i == 11142)items[i].u_gtwl = 110000;
		if (items[i].u_gtwl != 0) untradeitem.push_back(make_pair(items[i].u_gtwl, i));

		//opc shp
		if (i == 1404 || i == 448 || i == 1796)  items[i].oprc = 1;
		if (i == 2978)  items[i].oprc = 2;
		if (i == 826 || i == 262 || i == 1486)  items[i].oprc = 3;
		if (i == 9286 || i == 10826)  items[i].oprc = 4;
		if (i == 3560 || i == 10396 || i == 11156)  items[i].oprc = 5;
		if (i == 2254 || i == 2256 || i == 2258 || i == 2260 || i == 2262 || i == 2264)  items[i].oprc = 8;
		if (i == 1904 || i == 1996 || i == 1932 || i == 2970 || i == 8962) items[i].oprc = 15;
		if (i == 6856 || i == 9266) items[i].oprc = 18;
		if (i == 1876 || i == 1874 || i == 1986 || i == 6028 || i == 11094 || i == 6846) items[i].oprc = 20;
		if (i == 5130 || i == 5184 || i == 5148 || i == 5166)  items[i].oprc = 21;
		if (i == 11476) items[i].oprc = 22;
		if (i == 5480) items[i].oprc = 23;
		if (i == 4330 || i == 5638) items[i].oprc = 25;
		if (i == 11748)  items[i].oprc = 35;
		if (i == 7188)  items[i].oprc = 85;
		if (items[i].oprc != 0) opc_item.push_back(make_pair(items[i].oprc, i));

		//premium shop
		if (i == 1796)  items[i].pwl = 1;
		if (i == 10424 || i == 11478)  items[i].pwl = 10;
		if (i == 9266)  items[i].pwl = 10;
		if (i == 12600)  items[i].pwl = 15;
		if (i == 11748 || i == 6878 || i == 8306 || i == 9410)  items[i].pwl = 55;
		if (i == 5480 || i == 5638)  items[i].pwl = 30;
		if (i == 5152 || i == 9730 || i == 7188)  items[i].pwl = 40;
		if (i == 6312 || i == 5276)  items[i].pwl = 50;
		if (i == 11118)  items[i].pwl = 200;
		...
		if (i == 962 || i == 16 || i == 3472 || i == 954 || i == 880 || i == 188 || i == 190 || i == 22) {
			...
			items[i].randomitem.push_back(10394);
			items[i].chance = 50;
		}
		else if (i == 3782) {
			...
			items[i].randomitem.push_back(2410);
			items[i].chance = 5;
		}
		else if (i == 100) {
	...
	for (int i = 0; i < itemCount; i++) {
		...
		if (i == 11560 || i == 11554 || i == 11556 || i == 11558) items[i].flagmay = 1048576;
		if (i == 10956 || i == 10958 || i == 10954 || i == 10952 || i == 10960) items[i].flagmay = 262400;
		if (i == 12014 || i == 12016 || i == 12018 || i == 12020) items[i].flagmay = 2097168;
		if (i == 12646 || i == 12648 || i == 12650) items[i].flagmay = 8388864;
		if (i == 11506 || i == 11508) items[i].flagmay = 524544;
		if (i == 12866 || i == 12868) items[i].flagmay = 33554688;
		if (i == 12872 || i == 12874) items[i].flagmay = 67109120;
		if (i == 10426) items[i].flagmay = 2048;
		if (i == 10412) items[i].flagmay = 1024;
		if (items[i].clothingType == 6 and i % 2 == 0 and i != 448 and i != 9532) {
			rare_text += "\nadd_label_with_icon|small| " + items[i].name + "|left|" + to_string(i) + "|";
			items[8226].randomitem.push_back(i);
		}
		if (items[i].clothingType == 5 and i % 2 == 0 and i != 1782 and i != 2592 and i != 6026 and i != 6312 and i != 7586 and i != 9758 and i != 11158 and i != 12230 and i != 12242) {
			exe_text += "\nadd_label_with_icon|small| " + items[i].name + "|left|" + to_string(i) + "|"; 
			items[4762].randomitem.push_back(i);
		}
		if (items[i].r_1 != 0 or items[i].r_2 != 0 and items[i].rarity > 1 and i != 1790) {
			small_text += "\nadd_label_with_icon|small| " + items[i].name + "|left|" + to_string(i) + "|";
			items[9380].randomitem.push_back(i);
		}
		if (items[i].blockType == BlockTypes::LOCK and i != 2408 and i != 4802 and i != 5814 and i != 7188 and i != 9640) {
			rainbow_text += "\nadd_label_with_icon|small| " + items[i].name + "|left|" + to_string(i) + "|";
			items[7382].randomitem.push_back(i);
		}
		...
		if (i == 12542) items[i].emoji = "(plead)|Ľ|1&";
		if (i == 12544) items[i].emoji = "(moyai)|ļ|1&";
	...
	for (int i = 0; i < zombieitem.size(); i++) zombie_list += "\nadd_button_with_icon|zomb_price_" + to_string(zombieitem[i].second) + "|" + setGems(zombieitem[i].first) + "VC|noflags|" + to_string(zombieitem[i].second) + "||";
	...
	sort(voucheritem.begin(), voucheritem.end());
	for (int i = 0; i < voucheritem.size(); i++) voucher_list += "\nadd_button_with_icon|zvc_price_" + to_string(voucheritem[i].second) + "|" + setGems(voucheritem[i].first) + "VC|noflags|" + to_string(voucheritem[i].second) + "||";
...
bool onlynum(const string& str_) {
	if (str_.find_first_not_of("01234567890") != string::npos)
		return true;
	return false;
}
